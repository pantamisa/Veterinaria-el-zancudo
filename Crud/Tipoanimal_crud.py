...
class Tipoanimal_crud:
    def __init__(self, db: Session):
        self.db = db

    def crear_tipo_animal(
        self, nombre: str, id_usuario_crea: str
    ) -> Tipo_animal:
        """Crear un nuevo tipo de animal"""
        tipo = Tipo_animal(nombre=nombre, id_usuario_crea=id_usuario_crea)
        self.db.add(tipo)
        self.db.commit()
        self.db.refresh(tipo)
        return tipo

    def obtener_tipo_animal(self, id_tipoAnimal: int) -> Optional[Tipo_animal]:
    ...
    def actualizar_tipo_animal(
        self, id_tipoAnimal: int, id_usuario_edita: str, **kwargs
    ) -> Optional[Tipo_animal]:
    ...
    def eliminar_tipo_animal(self, id_tipoAnimal: int) -> bool:
